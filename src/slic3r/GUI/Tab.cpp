...
void TabPrint::build()
{
    ...
    page = add_options_page(L("Speed"), "custom-gcode_speed"); // ORCA: icon only visible on placeholders
        ...
        optgroup->append_single_option_line("minimum_cruise_ratio_enable", "speed_settings_acceleration");
        ...
        optgroup->append_single_option_line("minimum_cruise_ratio", "speed_settings_acceleration");
